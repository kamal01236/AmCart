...
spa_logout_url   = "https://dev.amcart.com/logout"
api_identifier_uri = "api://amcart-api-dev"
api_scopes = [
  {
    value                      = "Catalog.Read"
...
github_federations = [
  {
    ...
    subject      = "repo:acme/amcart:environment:dev"
    audiences    = ["api://AzureADTokenExchange"]
    description  = "GitHub Actions workflow deploying dev regions"
  }
]
config_key_vault_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-amcart-shared-dev/providers/Microsoft.KeyVault/vaults/kv-amcart-shared-dev"
